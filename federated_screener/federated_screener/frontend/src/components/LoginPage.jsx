...
export default function LoginPage({ onLogin }) {
  ...
  const handleLogin = async (e) => {
    ...
    // Simulate authentication (in production, call backend)
    try {
        ...
        <div className="bg-white rounded-lg shadow-2xl p-8">
          ...
          <div className="mt-6 pt-6 border-t border-gray-200">
            ...
            <div className="bg-gray-50 rounded p-3 text-xs text-gray-700 space-y-1">
              <p><strong>Username:</strong> SaiPrasad24</p>
              <p><strong>Password:</strong> 2724 (or any password)</p>
            </div>
          </div>
